...
export default function NuevoTrabajoModal({ onClose }: Props) {
  ...
  return (
    <div className="fixed inset-0 bg-gray-950 z-50 overflow-y-auto">
      <div className="min-h-screen px-4 pt-5 pb-12 max-w-lg mx-auto">
        {/* Header */}
        <div className="flex items-center justify-between mb-6">
          <h2 className="text-xl font-black text-white uppercase tracking-wide">Nuevo Trabajo</h2>
          <button
            onClick={onClose}
            className="text-gray-400 text-5xl leading-none w-12 h-12 flex items-center justify-center"
          >
            ×
          </button>
        </div>
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            {clienteStatus === 'existente' && (
              <p className="text-green-400 text-sm mt-1.5 font-bold">
          ...
          <button
            ...
            className="w-full bg-orange-500 active:bg-orange-600 disabled:bg-gray-800 disabled:text-gray-600 text-black font-black text-xl py-6 rounded-2xl uppercase tracking-wide"
          >
